...
namespace ILGPU.Compiler.DebugInformation
{
    ...
    public struct Scope : IEnumerable<LocalVariable>, IEquatable<Scope>
    {
        ...
        public struct VariableEnumerator : IEnumerator<LocalVariable>
        {
            ...
            /// </summary>
            /// <param name="localVariables">The colleciton of local variables.</param>
        ...
        public static bool operator ==(Scope first, Scope second)
        {
