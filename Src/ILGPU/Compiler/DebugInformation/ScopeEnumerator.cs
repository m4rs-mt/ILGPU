...
namespace ILGPU.Compiler.DebugInformation
{
    ...
    /// </summary>
    public sealed class ScopeEnumerator : IDebugInformationEnumerator<Scope>
    {
        #region Constants
        ...
        public static readonly ScopeEnumerator Empty = new ScopeEnumerator();
        ...
        /// </summary>
        public Scope? Current => scopes.Count < 1 ? new Scope?() : new Scope(scopes.Peek(), MetadataReader);
