...
{
    /// <summary>
    /// A uniform value type representing an exported <see cref="Types.TypeNode"/> from an <see cref="IRContext"/>.
    /// </summary>
    /// <param name="Id">Corresponds to <see cref="Node.Id"/></param>
    /// <param name="Class">A <see cref="Classifier"/> value denoting which kind of <see cref="Types.TypeNode"/> this instance represents</param>
    /// <param name="Nodes">A list of <see cref="NodeId"/> values corresponding to those of related instances; important for later reconstruction</param>
    /// <param name="BasicValueType">Corresponds to <see cref="Types.TypeNode.BasicValueType"/></param>
