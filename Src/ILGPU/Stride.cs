...
/// A generic stride based on 32-bit and 64-bit index information.
/// </summary>
/// <typeparam name="TSelf">The inner type.</typeparam>
/// <typeparam name="TIndex">The actual 32-bit stride index.</typeparam>
/// <typeparam name="TLongIndex">The 64-bit stride index.</typeparam>
public interface IStride<TSelf, TIndex, TLongIndex> : IStride<TIndex, TLongIndex>
    where TSelf : IStride<TSelf, TIndex, TLongIndex>
    where TIndex : struct, IIntIndex<TIndex, TLongIndex>
    where TLongIndex : struct, ILongIndex<TLongIndex, TIndex>
{
    /// <summary>
    ...
    static abstract TSelf FromExtent(TIndex extent);
    ...
    /// <param name="extent">The dimension for index computation.</param>
    /// <returns>The derived stride information.</returns>
    static abstract TSelf FromExtent(TLongIndex extent);
}
...
public static class StrideExtensions
{
        ...
        where T : unmanaged
    {
        ...
        if (alignmentInBytes < 1 || !XMath.IsPowerOf2(alignmentInBytes))
        {
        ...
        long pitchedBytes = Interop.Align(unpichtedBytes, alignmentInBytes);
    ...
    public readonly struct ElementSizeCastContext(int elementSize, int newElementSize) :
        IStrideCastContext
    {
        /// <summary>
...
partial class Stride2D
{
        ...
        ICastableStride<Index2D, LongIndex2D, DenseX>
    {
        ...
        /// </summary>
        public Index2D StrideExtent => new Index2D(XStride, YStride);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public General AsGeneral() => new(StrideExtent);

        /// <summary>
        /// Converts this stride instance into a general 1D stride.
        /// </summary>
        public Stride1D.General To1DStride() => new(XStride);
        ...
        ICastableStride<Index2D, LongIndex2D, DenseY>
    {
        ...
        /// Converts this stride instance into a general 1D stride.
        /// </summary>
        public Stride1D.General To1DStride() => new(YStride);
...
partial class Stride3D
{
        ...
        ICastableStride<Index3D, LongIndex3D, DenseZY>
    {
        ...
        /// Converts this stride instance into a general 1D stride.
        /// </summary>
        public Stride1D.General To1DStride() => new(ZStride);
