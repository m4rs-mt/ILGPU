    ...
    where T : unmanaged
{
    ...
    /// </summary>
    /// <remarks>This property is not supported on accelerators.</remarks>
    internal MemoryBuffer Buffer { [NotInsideKernel] get; }
    ...
    /// <param name="index">The element index.</param>
    /// <returns>The element at the given index.</returns>
    public unsafe ref T this[Index1D index]
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [ViewIntrinsic]
    ...
    /// <param name="index">The element index.</param>
    /// <returns>The element at the given index.</returns>
    public unsafe ref T this[LongIndex1D index]
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [ViewIntrinsic]
    ...
    /// <remarks>This method is not supported on accelerators.</remarks>
    [NotInsideKernel]
    internal long GetIndexInBytes() => Index * ElementSize;
    ...
    /// <remarks>This method is not supported on accelerators.</remarks>
    [NotInsideKernel]
    ArrayView<byte> IContiguousArrayView.AsRawArrayView() =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private long ComputeNumUnalignedElementsToSkip(int alignmentInBytes)
    {
        long alignmentOffset = Interop.ComputeAlignmentOffset(
            LoadEffectiveAddressAsPtr().ToInt64(),
            alignmentInBytes);
        return XMath.Min(alignmentOffset / Interop.SizeOf<T>(), Length);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [ViewIntrinsic]
    internal (ArrayView<T> Prefix, ArrayView<T> Main) AlignToInternal(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [ViewIntrinsic]
    internal ArrayView<T> AsAlignedInternal(int alignmentInBytes)
    {
        Trace.Assert(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal unsafe ref byte LoadEffectiveAddress(long index) =>
    ...
    /// <returns>The effective address.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal unsafe IntPtr LoadEffectiveAddressAsPtr(long index) =>
    ...
    /// <returns>The effective address.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal unsafe ref byte LoadEffectiveAddress() =>
    ...
    /// <returns>The effective address.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal unsafe IntPtr LoadEffectiveAddressAsPtr() =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ArrayView<T> SubView(long index)
    {
        Trace.Assert(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [ViewIntrinsic]
    public ArrayView<T> SubView(int index, int subViewLength) =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [ViewIntrinsic]
    public ArrayView<T> SubView(long index, long subViewLength)
    {
        Trace.Assert(
            index >= 0 && index < Length || index == 0 && Length < 1,
            "Index out of bounds");
    ...
    public static implicit operator ArrayView1D<T, Stride1D.Dense>(ArrayView<T> view) =>
    ...
    /// </summary>
    /// <returns>The corresponding generic view.</returns>
    public static implicit operator ArrayView<T>(ArrayView1D<T, Stride1D.Dense> view) =>
