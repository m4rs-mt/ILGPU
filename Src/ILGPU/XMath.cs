...
/// <summary>
/// Represents basic math helpers for general double/float math operations that are
/// supported on the CPU and the GPU.
/// </summary>
/// <remarks>
/// NOTE: This class will be replaced by a specific fast-math implementations for cross
/// platform (CPU/GPU) math functions in a future release.
/// </remarks>
public static partial class XMath
{
    ...
    /// <summary>
    /// Returns true if the current kernel is being compiled in fast math mode.
    /// </summary>
    /// <remarks>
    /// Note that this property is only supported inside kernels.
    /// </remarks>
    public static bool FastMath
    {
        [BackendIntrinsic]
    ...
    /// <summary>
    /// Returns true if denormalized numbers should be flushed to zero to improve
    /// performance.
    /// </summary>
    /// <remarks>
    /// Note that this property is only supported inside kernels.
    /// </remarks>
    public static bool FlushToZero
    {
        [BackendIntrinsic]
        get => throw new InvalidKernelOperationException();
    }
    ...
    /// <summary>
    /// Returns true if either <see cref="FastMath"/> or <see cref="FlushToZero"/> is
    /// set.
    /// performance.
    /// </summary>
    /// <remarks>
    /// Note that this property is only supported inside kernels.
    /// </remarks>
    public static bool OptimizePerformance => FastMath | FlushToZero;
}
