...
public abstract class AcceleratorObject : DisposeBase, IAcceleratorObject
{
    ...
    protected AcceleratorObject(Accelerator? accelerator)
    {
        ...
        AcceleratorType = accelerator?.AcceleratorType ?? AcceleratorType.None;
    ...
    /// <see cref="Accelerator.DisposeChildObjects_Locked(bool)"/>.
    /// </remarks>
...
partial class Accelerator
{
    ...
    /// </summary>
    private void DisposeChildObjects_Locked(bool disposing)
    {
