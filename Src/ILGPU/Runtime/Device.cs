...
public interface IDevice
{
    ...
    /// <summary>
    /// Returns the accelerator type of the device type.
    /// </summary>
    ...
    /// on this device.
    /// </summary>
    KernelSize OptimalKernelSize { get; }
...
/// Represents an abstract device object.
/// </summary>
public interface IDeviceAcceleratorTypeInfo
{
    /// <summary>
    /// Returns the accelerator type of the device type.
    /// </summary>
    static abstract AcceleratorType AcceleratorType { get; }
}
...
public abstract class Device(AcceleratorType type) : IDevice, IAcceleratorBuilder
{
    #region Properties
    ...
    /// </summary>
    public AcceleratorType AcceleratorType { get; } = type;
    ...
    /// on this device.
    /// </summary>
    public KernelSize OptimalKernelSize { get; protected set; }
    ...
    {
        writer.Write("  Max number of threads:                     ");
        ...
        writer.Write("  Optimal kernel size to target all threads: ");
        writer.WriteLine(OptimalKernelSize);
...
public sealed class DeviceRegistry
{
    ...
    /// </summary>
    private readonly HashSet<Device> _registered = [];
