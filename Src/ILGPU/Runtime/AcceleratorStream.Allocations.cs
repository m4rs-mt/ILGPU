...
//                                    www.ilgpu.net
//
// File: AcceleratorStream.Allocations.cs
//
...
partial class AcceleratorStream
{
    ...
    public virtual MemoryBuffer AllocateRaw(long length, int elementSize) =>
        Accelerator.AsNotNull().AllocateRaw(length, elementSize);
