    ...
    where TPointerModeHandler : struct, ICuBlasPointerModeHandler<TPointerModeHandler>
{
    ...
    public CuBlasPointerMode PointerMode
    {
        ...
        set => CuBlasException.ThrowIfFailed(API.SetPointerMode(Handle, value));
    }
    ...
    public CuBlasAtomicsMode AtomicsMode
    {
        ...
        set => CuBlasException.ThrowIfFailed(API.SetAtomicsMode(Handle, value));
    }
    ...
    public CuBlasMathMode MathMode
    {
        ...
        set => CuBlasException.ThrowIfFailed(API.SetMathMode(Handle, value));
    }
    ...
    private void EnsureAcceleratorBinding() =>
        Stream.Accelerator.AsNotNull().Bind();
