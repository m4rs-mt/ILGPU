...
public static class CudaContextExtensions
{
    ...
    public static Context.Builder Cuda(
        ...
        builder.CudaInternal(
            ...
            desc =>
                ...
                CudaAccelerator.SupportedInstructionSets.Contains(
        ...
        Predicate<CudaDevice> predicate)
    {
        ...
        CudaDevice.GetDevices(configure, predicate, builder.DeviceRegistry);
        return builder;
    }
    ...
    /// </summary>
    private const string WslLibraryBasePath = "/usr/lib/wsl/lib";
    ...
    private static bool IsRunningOnWSL()
    {
        try
        {
            return RuntimeInformation.IsOSPlatform(OSPlatform.Linux)
                ...
                && Directory.Exists(WslLibraryBasePath);
        }
        catch (Exception)
        {
            return false;
        ...
        DllImportSearchPath? searchPath)
    {
        ...
        foreach (var (prefix, suffix) in WslLibraryCombinations)
        {
            ...
            var libraryPath = Path.Combine(WslLibraryBasePath, filename);
