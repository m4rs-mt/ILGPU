...
//                                    www.ilgpu.net
//
// File: AcceleratorArchitecture.cs
//
...
/// <summary>
/// Represents an accelerator architecture.
/// </summary>
/// <param name="major">The major version.</param>
/// <param name="minor">The minor version.</param>
public readonly partial struct AcceleratorArchitecture(int major, int minor) :
    IEquatable<AcceleratorArchitecture>,
    IComparable<AcceleratorArchitecture>
{
    #region Static
    ...
    /// </remarks>
    public static AcceleratorArchitecture Current
    {
        [BackendIntrinsic]
    ...
    /// </returns>
    public bool Equals(AcceleratorArchitecture other) => this == other;
    ...
    public int CompareTo(AcceleratorArchitecture other)
    {
        if (this < other)
            return -1;
        else if (this > other)
    ...
    public override bool Equals(object? obj) =>
        obj is AcceleratorArchitecture architecture && architecture == this;
    ...
    public static bool operator ==(
        AcceleratorArchitecture first,
        AcceleratorArchitecture second) =>
