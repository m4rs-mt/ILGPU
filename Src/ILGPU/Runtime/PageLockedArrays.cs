    ...
    where T : unmanaged
{
    ...
    /// </summary>
    public static readonly PageLockedArray1D<T> Empty = new(null, LongIndex1D.Zero);
    ...
    /// </summary>
    public LongIndex1D Extent => _array.LongLength;

    /// <inheritdoc/>
    public override Span<T> Span => _array.AsSpan();
    ...
    /// <param name="index">The index of the array element.</param>
    /// <returns>The determined value reference.</returns>
    public ref T this[long index] => ref _array[index];
...
public static partial class PageLockedArrayExtensions
{
    ...
    public static PageLockedArray1D<T> AllocatePageLocked1D<T>(
        ...
        LongIndex1D extent,
        bool uninitialized)
        where T : unmanaged => new(accelerator, extent, uninitialized);
}
