...
partial class PTXInstructions
{
    ...
    private static readonly Dictionary<ArithmeticBasicValueType, string> LEAMulOperations = new()
    {
    ...
    private static readonly Dictionary<BasicValueType, string> SelectValueOperations = new()
    {
    ...
    private static readonly Dictionary<(CompareKind, ArithmeticBasicValueType), string> CompareOperations = new()
    {
    ...
    private static readonly Dictionary<(CompareKind, ArithmeticBasicValueType), string> CompareUnorderedFloatOperations = new()
    {
    ...
    private static readonly Dictionary<(ArithmeticBasicValueType, ArithmeticBasicValueType), string> ConvertOperations = new()
    {
    ...
    private static readonly Dictionary<(UnaryArithmeticKind, ArithmeticBasicValueType), string> UnaryArithmeticOperations = new()
    {
        // Basic arithmetic
    ...
    private static readonly Dictionary<(UnaryArithmeticKind, ArithmeticBasicValueType), string> UnaryArithmeticOperationsFastMath = new()
    {
        { (UnaryArithmeticKind.Neg, ArithmeticBasicValueType.Float16), "neg.ftz.f16" },
        { (UnaryArithmeticKind.Neg, ArithmeticBasicValueType.Float32), "neg.ftz.f32" },
    };

    private static readonly Dictionary<(BinaryArithmeticKind, ArithmeticBasicValueType), string> BinaryArithmeticOperations = new()
    {
        // Basic arithmetic
    ...
    private static readonly Dictionary<(BinaryArithmeticKind, ArithmeticBasicValueType), string> BinaryArithmeticOperationsFastMath = new()
    {
        // Basic arithmetic
    ...
    private static readonly Dictionary<(TernaryArithmeticKind, ArithmeticBasicValueType), string> TernaryArithmeticOperations = new()
    {
