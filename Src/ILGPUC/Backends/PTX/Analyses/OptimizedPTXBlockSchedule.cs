...
sealed class OptimizedPTXBlockSchedule<TOrder, TDirection>(
    in BasicBlockCollection<TOrder, TDirection> blocks) :
    PTXBlockSchedule<TOrder, TDirection>(blocks)
    ...
    where TDirection : struct, IControlFlowDirection
{
    ...
    public BasicBlockMap<int> BlockIndices { get; } =
        blocks.CreateMap(new BasicBlockMapTraversalIndexProvider());
