...
/// </typeparam>
interface IBackendCodeGenerator<TKernelBuilder> : IBackendCodeGenerator
{
    /// <summary>
...
/// </summary>
static class BackendCodeGenerator
{
    /// <summary>
    /// Creates a new code-generation visitor wrapper.
    /// </summary>
    /// <param name="codeGenerator">The parent code generator.</param>
    private readonly struct BackendValueVisitor<TCodeGenerator>(
        TCodeGenerator codeGenerator) : IValueVisitor
