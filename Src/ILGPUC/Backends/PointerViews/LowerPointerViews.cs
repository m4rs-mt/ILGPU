...
namespace ILGPUC.Backends.PointerViews;

/// <summary>
/// Lowers view instances into pointer view implementations.
/// </summary>
sealed class LowerPointerViews : LowerViews
{
    ...
    /// </summary>
    private sealed class PointerViewLowering(Method.Builder builder) :
        ViewTypeLowering(builder)
    {
        /// <summary>
    ...
    /// </summary>
    private static readonly Rewriter<TypeLowering<ViewType>> Rewriter = new();
