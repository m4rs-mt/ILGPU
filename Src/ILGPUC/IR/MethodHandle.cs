...
/// <summary>
/// Represents a method handle to an <see cref="Method"/> that is valid across
/// transformations.
/// </summary>
/// <param name="Id">The unique id.</param>
/// <param name="Name">The name of the referenced method.</param>
readonly record struct MethodHandle(long Id, string Name)
{
    /// <summary>
    ...
    public static MethodHandle Create(string name) => new(0, name);
