...
using static ILGPUC.IR.Values.TerminatorValue;
...
sealed class IRRebuilder
{
    ...
    /// </summary>
    internal readonly struct CloneMode : IMode
    {
        /// <summary>
    ...
    /// </summary>
    internal readonly struct InlineMode : IMode
    {
        /// <summary>
