...
sealed partial class BasicBlock :
    ValueParent,
    ...
    IDumpable
{
    ...
    /// </summary>
    internal readonly struct Comparer : IEqualityComparer<BasicBlock>
    {
        /// <summary>
    ...
    internal delegate void ValueVisitor<in TValue>(TValue value)
        where TValue : Value;
    ...
    internal readonly struct ValueEntry(int index, ValueReference valueReference)
    {
        /// <summary>
    ...
    /// </summary>
    internal struct Enumerator : IEnumerator<ValueEntry>
    {
        #region Instance

        private int _index;
        private readonly List<ValueReference> _values;
        ...
        /// </summary>
        public readonly ValueEntry Current => new(_index, _values[_index]);
    ...
    /// </summary>
    internal readonly struct TerminatorSuccessorsProvider :
    ...
    private InlineList<BasicBlock> _predecessors;

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private InlineList<BasicBlock> _successors;

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private List<ValueReference> _values = [];
        ...
        : base(location)
    {
        ...
        _predecessors = InlineList<BasicBlock>.Create(2);
        _successors = InlineList<BasicBlock>.Create(2);
    }
    ...
    public ValueReference this[int index] => _values[index];
    ...
    public void AssertNoControlFlowUpdate()
    {
        ...
        _builder.MethodBuilder.AssertNoControlFlowUpdate();
    }
        ...
        where TDirection : struct, IControlFlowDirection
    {
        ...
        return direction.IsForwards ? _predecessors : _successors;
    }
        ...
        where TDirection : struct, IControlFlowDirection
    {
        ...
        TDirection direction = default;
        return direction.IsForwards ? _successors : _predecessors;
    }
    ...
    {
        this.Assert(otherBuilder == _builder);
