...
/// </summary>
abstract class AddressSpaceType : TypeNode
{
    #region Nested Types
    ...
    /// </summary>
    internal sealed class AddressSpaceConverter : TypeConverter<AddressSpaceType>
    {
        /// <summary>
...
/// </summary>
sealed class PointerType : AddressSpaceType
{
    #region Instance
...
/// </summary>
sealed class ViewType : AddressSpaceType
{
    #region Instance
