...
/// </summary>
sealed class StructureType : ObjectType, IEnumerable<(TypeNode, FieldAccess)>
{
    #region Nested Types
    ...
    /// </summary>
    internal struct Enumerator : IEnumerator<(TypeNode, FieldAccess)>
    {
        private int index;
    ...
    /// </summary>
    internal readonly struct OffsetCollection :
        IReadOnlyCollection<(FieldAccess, int, int)>
    {
        ...
        /// </remarks>
        internal struct Enumerator : IEnumerator<(FieldAccess, int, int)>
        {
