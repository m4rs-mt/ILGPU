...
/// </summary>
sealed class IRTypeContext : TypeInformationManager, IIRTypeContext
{
    #region Static
    ...
    private readonly Dictionary<TypeNode, TypeNode> unifiedTypes = new();
    private readonly Dictionary<(Type, MemoryAddressSpace), TypeNode> typeMapping = new();
    private readonly PrimitiveType[] basicValueTypes;

    /// <summary>
    /// Constructs a new IR type context.
    /// </summary>
    /// <param name="properties">Main compilation context.</param>
    public IRTypeContext(CompilationProperties properties)
    {
        TargetPlatform = properties.TargetPlatform;
        MathMode = properties.MathMode;
