...
/// </summary>
sealed class Uniforms : GlobalFixPointAnalysis<Uniforms.ValueInfo, Forwards>
{
    #region Nested Types
    ...
    /// </summary>
    internal readonly struct ValueInfo : IEquatable<ValueInfo>
    {
        #region Instance
    ...
    /// </summary>
    internal readonly struct Info(GlobalAnalysisValueResult<ValueInfo> analysisResult)
    {
        #region Static
