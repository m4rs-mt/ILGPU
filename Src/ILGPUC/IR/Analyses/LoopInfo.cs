...
sealed class LoopInfo<TOrder, TDirection>
    ...
    where TDirection : struct, IControlFlowDirection
{
    ...
    public static LoopInfo<TOrder, TDirection> Create(
        ...
        ? loopInfo
        : throw loop.Entries.First().GetInvalidOperationException();
        ...
        out InlineList<(PhiValue, Value)> phiValues)
    {
        ...
        foreach (var phi in phis)
        {
            ...
            // other words, the phi value receives an argument via the back edge
...
/// <typeparam name="TOrder">The current order.</typeparam>
/// <typeparam name="TDirection">The control-flow direction.</typeparam>
readonly struct LoopInfos<TOrder, TDirection>
    where TOrder : struct, ITraversalOrder
    where TDirection : struct, IControlFlowDirection
{
    #region Static
...
readonly struct InductionVariableOperation<T>
    where T : struct
{
...
/// </summary>
readonly struct InductionVariableBounds
{
    #region Nested Types
    ...
    /// </summary>
    internal enum UpdateOperationKind
    {
        /// <summary>
        /// No known kind.
        /// </summary>
...
/// </summary>
sealed class InductionVariable
{
    #region Instance
