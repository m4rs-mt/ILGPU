...
interface IAnalysisValueSourceContext<T>
...
readonly struct ConstAnalysisValueSourceContext<T> :
...
/// </summary>
/// <typeparam name="T">The data type.</typeparam>
interface IAnalysisValueContext<T> : IAnalysisValueSourceContext<T>
    where T : IEquatable<T>
{
    /// <summary>
...
/// </remarks>
readonly struct AnalysisValue<T> :
...
readonly struct AnalysisValueMapping<T>
    where T : IEquatable<T>
{
    #region Instance
...
/// </summary>
/// <typeparam name="T">The target mapping type.</typeparam>
readonly struct AnalysisReturnValueMapping<T>
    where T : IEquatable<T>
{
    #region Instance
...
/// </summary>
static class AnalysisValueMapping
{
    /// <summary>
...
/// </summary>
static class AnalysisReturnValueMapping
{
    /// <summary>
