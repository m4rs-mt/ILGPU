...
interface IFixPointAnalysisContext<T, TNode>
    where TNode : Node
{
    /// <summary>
...
abstract class FixPointAnalysis<TData, TNode, TDirection>
...
/// <typeparam name="TData">The underlying data type of the analysis.</typeparam>
/// <typeparam name="TDirection">The control-flow direction.</typeparam>
abstract class BlockFixPointAnalysis<TData, TDirection> :
...
/// <typeparam name="TDirection">The control-flow direction.</typeparam>
abstract class ValueFixPointAnalysis<T, TDirection> :
...
/// </typeparam>
interface IGlobalFixPointAnalysisContext<TMethodData, T> :
    IFixPointAnalysisContext<AnalysisValue<T>, Value>,
...
/// </typeparam>
readonly struct GlobalAnalysisResult<T, TMethodData>
    where T : IEquatable<T>
{
    #region Instance
...
/// </typeparam>
/// <typeparam name="TDirection">The control-flow direction.</typeparam>
abstract class GlobalFixPointAnalysis<TMethodData, T, TDirection> :
...
readonly struct GlobalAnalysisValueResult<T>
    where T : struct, IEquatable<T>
{
    #region Static
    ...
    public static readonly GlobalAnalysisValueResult<T> Empty =
        new GlobalAnalysisValueResult<T>(new());
...
/// </typeparam>
/// <typeparam name="TDirection">The control-flow direction.</typeparam>
abstract class GlobalFixPointAnalysis<T, TDirection> :
