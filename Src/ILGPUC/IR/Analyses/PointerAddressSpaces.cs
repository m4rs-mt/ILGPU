...
sealed class PointerAddressSpaces(PointerAddressSpaces.AnalysisFlags flags) :
    GlobalFixPointAnalysis<PointerAddressSpaces.AddressSpaceInfo, Forwards>(default)
{
    #region Nested Types
    ...
    /// </summary>
    [Flags]
    internal enum AddressSpaceFlags : int
    {
        /// <summary>
    ...
    internal readonly struct AddressSpaceInfo(AddressSpaceFlags flags) :
        IEquatable<AddressSpaceInfo>
    {
        #region Nested Types
        ...
        /// </summary>
        internal struct Enumerator : IEnumerator<MemoryAddressSpace>
        {
            #region Instance
    ...
    /// parameter.
    /// </summary>
    internal readonly struct ConstParameterValueContext :
    ...
    /// </summary>
    internal readonly struct AutomaticParameterValueContext :
        IAnalysisValueSourceContext<AddressSpaceInfo>
    {
        /// <summary>
    ...
    private bool HasFlags(AnalysisFlags flags) =>
