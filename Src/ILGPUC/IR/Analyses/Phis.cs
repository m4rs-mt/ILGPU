...
using PhiValueList = ILGPU.Util.InlineList<ILGPUC.IR.Values.PhiValue>;
...
readonly ref struct Phis
{
    ...
    /// </summary>
    /// <param name="phis">The phi analysis instance to convert.</param>
...
/// </summary>
static class PhiValueExtensions
{
    /// <summary>
