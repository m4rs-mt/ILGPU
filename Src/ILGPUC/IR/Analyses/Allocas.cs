...
/// </summary>
readonly struct AllocaInformation
{
    #region Instance
    ...
    public AllocaInformation(int index, Alloca alloca)
    {
        Index = index;
        Alloca = alloca;
...
/// </summary>
readonly record struct AllocaKindInformation(
...
/// </summary>
readonly struct AllocaAlignments
{
    #region Static
    ...
    public static AllocaAlignments Create(int capacity) => new(capacity);
