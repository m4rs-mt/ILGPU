...
partial struct BasicBlockSet
{
        ...
        : this()
    {
        ...
        visited = new ulong[XMath.DivRoundUp(numBlocks, 64)];
...
/// </summary>
struct BasicBlockSetList : IReadOnlyList<BasicBlock>
{
    #region Static
...
interface IBasicBlockMapValueProvider<T>
{
    /// <summary>
...
/// </summary>
readonly struct BasicBlockMapTraversalIndexProvider :
...
partial struct BasicBlockMap<T> : IReadOnlyCollection<(BasicBlock, T)>
{
    #region Nested Types
    ...
    /// </summary>
    internal struct Enumerator : IEnumerator<(BasicBlock, T)>
    {
