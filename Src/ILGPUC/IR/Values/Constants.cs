...
/// </summary>
abstract class ConstantNode : Value
{
    #region Instance
...
/// </summary>
sealed partial class NullValue : ConstantNode
{
    #region Instance
...
sealed partial class PrimitiveValue : ConstantNode
{
    ...
    protected override string ToArgString()
    {
        ...
        {
            BasicValueType.Int1 => $"{Int1Value}",
            BasicValueType.Int8 => $"{Int8Value}",
            BasicValueType.Int16 => $"{Int16Value}",
            BasicValueType.Int32 => $"{Int32Value}",
            BasicValueType.Int64 => $"{Int64Value}",
            BasicValueType.Float16 => $"{Float16Value}",
            BasicValueType.Float32 => $"{Float32Value}",
            BasicValueType.Float64 => $"{Float64Value}",
            _ => $"Raw({rawValue})",
        };
...
/// </summary>
sealed partial class StringValue : ConstantNode
{
    #region Instance
