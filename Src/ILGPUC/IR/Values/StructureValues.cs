...
/// </summary>
readonly struct FieldSpan : IEquatable<FieldSpan>
{
    #region Instance
...
/// </summary>
sealed partial class StructureValue : Value
{
    #region Nested Types
    ...
    /// </summary>
    internal interface IBuilder : IValueBuilder { }
...
/// </summary>
abstract class StructureOperationValue : Value
{
    #region Instance
