...
/// </remarks>
struct ValueReference(Value node) : IValue, IEquatable<ValueReference>
{
    #region Properties
    ...
    /// </summary>
    public Value DirectTarget { get; private set; } = node;
    ...
    /// </summary>
    public readonly bool IsReplaced => IsValid && DirectTarget.IsReplaced;
    ...
    public void Accept<TVisitor>(TVisitor visitor) where TVisitor : IValueVisitor =>
