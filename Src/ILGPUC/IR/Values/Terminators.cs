...
using System.Text;
using BlockList = ILGPU.Util.InlineList<ILGPUC.IR.BasicBlock>;
...
/// </summary>
abstract class TerminatorValue : Value
{
    #region Nested Types
    ...
    /// Remaps basic blocks.
    /// </summary>
    internal interface IBlockRemapper
    {
        /// <summary>
    ...
    /// </summary>
    internal interface IDirectTargetRemapper
    {
        /// <summary>
    ...
    /// An abstract target remapper.
    /// </summary>
    internal interface ITargetRemapper : IBlockRemapper, IDirectTargetRemapper { }

    /// <summary>
    /// An identity remapper that does not remap any targets.
    /// </summary>
    internal readonly struct IdentityRemapper : ITargetRemapper
    {
        #region Methods
...
/// </summary>
sealed partial class ReturnTerminator : TerminatorValue
{
    #region Instance
...
/// </summary>
abstract class Branch : TerminatorValue
{
    #region Instance
...
/// </summary>
sealed partial class UnconditionalBranch : Branch
{
    #region Instance
...
/// </summary>
abstract class ConditionalBranch : Branch
{
    #region Instance
...
/// </summary>
sealed partial class IfBranch : ConditionalBranch
{
    #region Instance
...
/// </summary>
sealed partial class SwitchBranch : ConditionalBranch
{
    #region Nested Types
...
/// </summary>
sealed partial class BuilderTerminator : Branch
{
    #region Nested Types
    ...
    /// <summary cref="Value.ToArgString"/>
    protected override string ToArgString() =>
        Targets.ToString(static block => block.ToString());
