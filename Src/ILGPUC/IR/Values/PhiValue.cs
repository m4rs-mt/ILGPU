...
/// </summary>
sealed partial class PhiValue : Value
{
    #region Nested Types
    ...
    /// </summary>
    internal interface IArgumentRemapper
    {
        /// <summary>
    ...
    /// </summary>
    internal readonly struct BlockRemapper : IArgumentRemapper
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TArgumentRemapper">The argument remapper type.</typeparam>
    ...
    public Value RemapArguments<TArgumentRemapper>(
        Method.Builder methodBuilder,
        TArgumentRemapper remapper)
        where TArgumentRemapper : struct, IArgumentRemapper
    {
    ...
    private string ToFullArgString() =>
        ...
        $" [{Sources.ToString(static t => t.ToReferenceString())}]";
