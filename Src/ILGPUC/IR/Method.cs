    ...
    IDumpable
{
    ...
    /// </summary>
    internal readonly struct ParameterCollection : IReadOnlyCollection<Parameter>
    {
        #region Nested Types
    ...
    /// </summary>
    internal readonly ref struct ParameterMapping
    {
        #region Instance
    ...
    /// </summary>
    internal readonly struct MethodMapping
    {
        #region Instance
    ...
    /// </summary>
    internal sealed class MethodLocation : Location
    {
        /// <summary>
    ...
    public Builder MethodBuilder
    {
        get
        {
            Location.AssertNotNull(builder);
            return builder.AsNotNull();
        }
    }
