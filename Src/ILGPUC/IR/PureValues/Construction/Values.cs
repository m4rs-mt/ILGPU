...
partial class PureValueBuilder
{
    ...
    public PureValue CreateNull(Location location, TypeValue type) =>
    ...
    public PureValue CreateEnumValue(Location location, object value)
    {
        if (value == null)
    ...
    /// <param name="value">The object value.</param>
    /// <returns>A reference to the requested value.</returns>
    public PureValue CreatePrimitiveValue(Location location, object value)
    {
        if (value == null)
            throw location.GetArgumentNullException(nameof(value));
        var type = value.GetType();
    ...
    /// <returns>A reference to the requested value.</returns>
    public PureValue CreatePrimitiveValue(
        Location location,
        string @string) =>
    ...
    public PrimitiveValue CreatePrimitiveValue(Location location, sbyte value) =>
        CreatePrimitiveValue(location, BasicValueType.Int8, value);
    ...
    public PrimitiveValue CreatePrimitiveValue(Location location, short value) =>
        CreatePrimitiveValue(location, BasicValueType.Int16, value);
    ...
    public PrimitiveValue CreatePrimitiveValue(Location location, int value) =>
        CreatePrimitiveValue(location, BasicValueType.Int32, value);
    ...
    public PrimitiveValue CreatePrimitiveValue(Location location, long value) =>
        CreatePrimitiveValue(location, BasicValueType.Int64, value);
    ...
    public PrimitiveValue CreatePrimitiveValue(Location location, Half value) =>
        CreatePrimitiveValue(location, BasicValueType.Float16, value.RawValue);
    ...
    public PrimitiveValue CreatePrimitiveValue(Location location, double value) =>
        ModuleBuilder.Properties.MathMode == MathMode.Fast32BitOnly
        ? CreatePrimitiveValue(location, (float)value)
        : CreatePrimitiveValue(
            location,
    ...
    /// </summary>
    /// <param name="location">The current location.</param>
    /// <param name="box">The value box.</param>
    /// <returns>The created primitive value.</returns>
    public PrimitiveValue CreatePrimitiveValue(
        Location location,
        in PrimitiveValueBox box) =>
        Append(new PrimitiveValue(GetInitializer(location), box));
    ...
    public PrimitiveValue CreatePrimitiveValue(
        ...
        BasicValueType type,
        long rawValue) =>
        CreatePrimitiveValue(location, new PrimitiveValueBox(type, rawValue));
        ...
        Type type)
    {
        ...
        if (value is not null && type != value.GetType())
        ...
        return type.GetArithmeticBasicValueType() switch
        {
            ...
            _ => value == null
                ? CreateNull(location, ModuleBuilder.CreateType(type))
