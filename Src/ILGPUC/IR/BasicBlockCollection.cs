    ...
    where TDirection : struct, IControlFlowDirection
{
    ...
    /// </summary>
    internal struct Enumerator : IEnumerator<BasicBlock>
    {
        private static TOrder GetOrder() => default;

        private readonly ImmutableArray<BasicBlock> _blocks;
        private TraversalEnumerationState _state;

        internal Enumerator(ImmutableArray<BasicBlock> blockArray)
        {
            _blocks = blockArray;
            _state = GetOrder().Init(blockArray);
        }

        /// <summary>
        /// Returns the current basic block.
        /// </summary>
        public BasicBlock Current => _blocks[_state.Index];
        ...
        public bool MoveNext() => GetOrder().MoveNext(_blocks, ref _state);

        /// <summary cref="IEnumerator.Reset"/>
        readonly void IEnumerator.Reset() => throw new InvalidOperationException();
    }

    /// <summary>
    /// An abstract view on all values.
    /// </summary>
    internal readonly struct ValueCollection : IEnumerable<BasicBlock.ValueEntry>
    {
        #region Nested Types
        ...
        /// </summary>
        internal struct Enumerator : IEnumerator<BasicBlock.ValueEntry>
        {
            private BasicBlockCollection<TOrder, TDirection>.Enumerator
                _blockEnumerator;
            private BasicBlock.Enumerator _valueEnumerator;
            ...
            internal Enumerator(ImmutableArray<BasicBlock> blocks)
            {
                ...
                _valueEnumerator = _blockEnumerator.Current.GetEnumerator();
            }

            /// <summary>
            /// Returns the current value and its parent basic block.
            /// </summary>
            public BasicBlock.ValueEntry Current => _valueEnumerator.Current;
        ...
        {
            _blocks = blockCollection._blocks;
        }
        ...
        public readonly Enumerator GetEnumerator() => new Enumerator(_blocks);
    ...
    public readonly ImmutableArray<BasicBlock> AsImmutable() => _blocks;

    /// <summary>
    /// Converts this collection into a hash set.
    /// </summary>
    /// <returns>The created set.</returns>
    public readonly HashSet<BasicBlock> ToSet() => ToSet(static _ => true);
    ...
    /// <returns>The created set.</returns>
    public readonly HashSet<BasicBlock> ToSet(Predicate<BasicBlock> predicate)
    {
    ...
    public readonly BasicBlockCollection<TOtherOrder, TDirection>
        ...
        new BasicBlockCollection<TOtherOrder, TDirection>(EntryBlock, _blocks);
    ...
    public readonly Enumerator GetEnumerator() => new(_blocks);
