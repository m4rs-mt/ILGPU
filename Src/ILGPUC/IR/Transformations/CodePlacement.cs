...
/// </remarks>
abstract class CodePlacement : SequentialUnorderedTransformation
{
    #region Basic Types
    ...
    /// </summary>
    internal readonly struct PlacementEntry
    {
        /// <summary>
    ...
    /// </summary>
    internal interface IPlacementStrategy
    {
        /// <summary>
    ...
    /// </summary>
    internal struct GroupOperands : IPlacementStrategy
    {
        /// <summary>
    ...
    /// </summary>
    internal struct MinimizeOperandDistances : IPlacementStrategy
    {
        /// <summary>
    ...
    where TStrategy : struct, CodePlacement.IPlacementStrategy
{
    ...
    /// </summary>
    private readonly struct AppendMode(in BasicBlockMap<(Value[], int)> blocks) :
        IPlacerMode
    {
