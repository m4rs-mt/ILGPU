...
using Loop = ILGPUC.IR.Analyses.Loops<
    ILGPUC.IR.Analyses.TraversalOrders.ReversePostOrder,
    ILGPUC.IR.Analyses.ControlFlowDirection.Forwards>.Node;
using LoopInfo = ILGPUC.IR.Analyses.LoopInfo<
    ILGPUC.IR.Analyses.TraversalOrders.ReversePostOrder,
    ILGPUC.IR.Analyses.ControlFlowDirection.Forwards>;
using LoopInfos = ILGPUC.IR.Analyses.LoopInfos<
    ILGPUC.IR.Analyses.TraversalOrders.ReversePostOrder,
    ILGPUC.IR.Analyses.ControlFlowDirection.Forwards>;
...
/// </summary>
sealed class LoopUnrolling : UnorderedTransformation
{
    #region Constants
