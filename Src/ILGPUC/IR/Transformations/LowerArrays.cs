...
/// </param>
sealed class LowerArrays(MemoryAddressSpace targetAddressSpace) : LowerTypes<ArrayType>
{
    #region Nested Types
    ...
    /// </summary>
    private static readonly Rewriter<TypeLowering<ArrayType>> Rewriter = new();
