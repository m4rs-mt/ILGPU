...
sealed class LowerStructures(LowerStructureFlags flags = LowerStructureFlags.None) :
    UnorderedTransformation
{
    ...
    /// </summary>
    private static void LowerThreadValue<TValue>(
        SSARewriterContext<FieldRef> context,
        StructureType structureType,
        TValue value,
        LowerThreadIntrinsics.LoweringHandler<TValue> loweringHandler)
    ...
    /// </summary>
    private readonly struct LoweringData(List<LoweredPhi> loweredPhis)
    {
        /// <summary>
    ...
    private static void Lower(
        ...
        LowerThreadValue(
            ...
            value,
            LowerThreadIntrinsics.LowerBroadcast);
    ...
    private static void Lower(
        ...
        LowerThreadValue(
            ...
            value.Type.AsNotNullCast<StructureType>(),
            value,
            LowerThreadIntrinsics.LowerShuffle);
    ...
    /// </summary>
    private static readonly SSARewriter<FieldRef, LoweringData> Rewriter = new();

    /// <summary>
    /// The internal rewriter that lowers load/store values.
    /// </summary>
    private static readonly SSARewriter<FieldRef, LoweringData> LoadStoreRewriter = new();
