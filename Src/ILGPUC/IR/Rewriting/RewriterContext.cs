...
readonly struct RewriterContext(
    BasicBlock.Builder builder,
    HashSet<Value>? converted) : IRewriterContext
{
    #region Static
    ...
    /// </summary>
    public BasicBlock.Builder Builder { get; } = builder;
    ...
    /// </summary>
    private HashSet<Value>? Converted { get; } = converted;
...
interface IRewriterContextProvider<TContext, T>
...
/// </summary>
/// <typeparam name="T">The custom data type.</typeparam>
readonly struct RewriterContextProvider<T> :
