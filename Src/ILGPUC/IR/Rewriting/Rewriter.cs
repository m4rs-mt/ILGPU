...
delegate bool RewritePredicate<T, TValue>(
    T data,
    TValue value);
...
delegate void RewriteConverter<TContext, T, TValue>(
    TContext context,
    T data,
    TValue value)
...
abstract class Rewriter<TContext, TContextProvider, TContextData, T>
    where TContext : struct, IRewriterContext
        ...
        IRewriterContextProvider<TContext, TContextData>
{
    ...
    /// </summary>
    internal readonly struct RewriterProcess(
        Rewriter<TContext, TContextProvider, TContextData, T> rewriter,
        ...
        HashSet<Value> toConvert)
    {
        ...
        /// </summary>
        public BlockCollection Blocks { get; } = blocks;

        /// <summary>
        /// Returns the parent builder.
        /// </summary>
        public Method.Builder Builder { get; } = builder;
        ...
        /// Returns the set of values to convert.
        /// </summary>
        private HashSet<Value> ToConvert { get; } = toConvert;
        ...
        where TValue : Value
    {
        ...
        {
            var targetValue = value.AsNotNullCast<TValue>();
...
/// <param name="data">The user-defined data.</param>
/// <param name="value">The value to rewrite.</param>
delegate void RewriteConverter<T, TValue>(
...
/// <param name="context">The current rewriting context.</param>
/// <param name="value">The value to rewrite.</param>
delegate void RewriteConverter<in TValue>(
    RewriterContext context,
    TValue value)
    where TValue : Value;
...
/// A rewriter class that does not work on user-defined context instances.
/// </summary>
sealed class Rewriter : Rewriter<object>
{
    /// <summary>
    /// Adds a new rewriter converter.
    /// </summary>
