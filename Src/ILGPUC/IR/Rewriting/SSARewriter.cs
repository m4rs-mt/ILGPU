...
readonly struct SSARewriterContext<TVariable> : IRewriterContext
    where TVariable : IEquatable<TVariable>
{
    ...
    public SSARewriterContext<TVariable> SpecializeBuilder(
        ...
        new(baseContext.SpecializeBuilder(newBuilder), SSABuilder);
...
/// </summary>
/// <typeparam name="TVariable">The SSA variable type.</typeparam>
readonly struct SSARewriterContextProvider<TVariable> :
...
sealed class SSARewriter<TVariable, T> :
    Rewriter<
    ...
    where TVariable : IEquatable<TVariable>
{
    ...
    /// </summary>
    internal readonly new struct RewriterProcess
    {
        #region Instance
    ...
    private static bool ProcessSSA<TProcessor>(
        SSABuilder<TVariable> ssaBuilder,
