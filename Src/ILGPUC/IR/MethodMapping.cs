...
sealed class MethodMapping<T> where T : class, IMethodMappingObject
{
    #region Nested Types
    ...
    /// </summary>
    internal readonly struct ReadOnlyCollection : IEnumerable<T>
    {
        #region Instance
    ...
    public ImmutableArray<T> ToImmutableArray() => [.. dataList];
