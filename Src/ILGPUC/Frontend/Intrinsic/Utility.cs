...
{
    /// <summary>
    /// Handles utility select functions.
    /// </summary>
    ...
    /// </summary>
    private static readonly Regex PTXExpressionRegex = PTXExpressionRegexGenerator();

    /// <summary>
    /// Handles <see cref="CudaAsm"/> emit operations.
    /// </summary>
    /// <param name="context">The current invocation context.</param>
    /// <returns>The resulting value.</returns>
    ...
    [GeneratedRegex("(%%|%\\d+|%)")]
    private static partial Regex PTXExpressionRegexGenerator();
