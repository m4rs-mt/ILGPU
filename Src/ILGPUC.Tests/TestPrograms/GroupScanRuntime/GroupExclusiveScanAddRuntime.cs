...
//                                    www.ilgpu.net
//
// File: GroupExclusiveScanAddRuntime.cs
//
// This file is part of ILGPU and is distributed under the University of Illinois Open
// Source License. See LICENSE.txt for details.
// ---------------------------------------------------------------------------------------

// Test program: GroupExclusiveScanAddRuntime
// Input read from a runtime buffer so the optimizer cannot fold.
// 4 threads, input = [1, 2, 3, 4], Group.ExclusiveScan(+, identity=0)
// Expected exclusive prefix sum: [0, 1, 3, 6]
...
{
    public static void GroupExclusiveScanAddRuntimeKernel(
        Index1D index,
...
static class Program
{
    static void Main()
    {
        ...
        stream.Launch(
            (Index1D)4,
            index => Kernels.GroupExclusiveScanAddRuntimeKernel(
