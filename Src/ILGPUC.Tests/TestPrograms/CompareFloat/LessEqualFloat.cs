...
// Test program: CompareFloat LessEqual<float>
// Kernel compares a <= b element-wise.
// a: [1.0, 5.0, 3.0, 7.0], b: [1.0, 4.0, 6.0, 8.0] → result: [1, 0, 1, 1]
...
static class Program
{
    static void Main()
    {
        ...
        float[] aData = [1.0f, 5.0f, 3.0f, 7.0f];
        float[] bData = [1.0f, 4.0f, 6.0f, 8.0f];
