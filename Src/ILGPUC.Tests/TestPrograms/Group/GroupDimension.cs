...
// Test program: GroupDimension
// Kernel stores Group.Dimension into data.
...
static class Program
{
    static void Main()
    {
        ...
        stream.Launch((Index1D)4, index => Kernels.GroupDimensionKernel(index, buffer.View));
        stream.Synchronize();
