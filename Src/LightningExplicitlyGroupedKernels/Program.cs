...
namespace LightningExplicitlyGroupedKernels
{
    class Program
    {
        /// <summary>
            ...
            using (var context = new Context())
            {
                ...
                foreach (var acceleratorId in LightningContext.Accelerators)
                {
                    ...
                    using (var lc = LightningContext.CreateContext(context, acceleratorId))
                    {
                        ...
                        var groupSize = lc.MaxThreadsPerGroup;
                        ...
                        using (var dataSource = lc.Allocate<int>(data.Length))
                        {
                            ...
                            using (var dataTarget = lc.Allocate<int>(data.Length))
                            {
                                ...
                                // Launch default grouped kernel
                                {
                                    ...
                                    var groupedKernel = lc.LoadStreamKernel<GroupedIndex, ArrayView<int>, int>(GroupedKernel);
                                ...
                                // Launch grouped kernel with barrier
                                {
                                    ...
                                    var groupedKernel = lc.LoadStreamKernel<GroupedIndex, ArrayView<int>, ArrayView<int>, int>(GroupedKernelBarrier);
                                ...
                                // Launch grouped kernel with and-barrier
                                {
                                    ...
                                    var groupedKernel = lc.LoadStreamKernel<GroupedIndex, ArrayView<int>, ArrayView<int>, int>(GroupedKernelAndBarrier);
                                ...
                                // Launch grouped kernel with or-barrier
                                {
                                    ...
                                    var groupedKernel = lc.LoadStreamKernel<GroupedIndex, ArrayView<int>, ArrayView<int>, int>(GroupedKernelOrBarrier);
                                    groupedKernel(launchDimension, dataSource, dataTarget.View, 64);
                                ...
                                // Launch grouped kernel with popcount-barrier
                                {
                                    ...
                                    var groupedKernel = lc.LoadStreamKernel<GroupedIndex, ArrayView<int>, ArrayView<int>, int>(GroupedKernelPopCountBarrier);
                                    groupedKernel(launchDimension, dataSource, dataTarget.View, 0);
